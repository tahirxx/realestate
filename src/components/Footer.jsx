...
export default function Footer() {
  return (
 <div>
  <footer className="bg-gray-400 py-7">
    <div className="mx-auto max-w-screen-xl px-4  sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
          <div className="col-span-2">
            <div>
              ...
              Explore our blog for insightful posts covering Real Estate, where our experts share trends and tips to keep you informed. Subscribe to our newsletter for exclusive weekly updates and special offers, and connect with us on social media for behind-the-scenes access, team interaction, and the latest blog post and news alerts.
              </p>
            </div>
          </div>
      ...
      <div className="mt-8 border-t border-gray-100 pt-8">
        <div className="sm:flex sm:justify-between">
          <p className="text-xs text-gray-500">&copy; 2024. RealtyHub. All rights reserved.</p>
